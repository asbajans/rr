...
const styles = StyleSheet.create({
  ...
  fInput: { borderWidth: 1, borderColor: '#ddd', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7, fontSize: 13, backgroundColor: '#fff', marginRight: 8, width: 90 },
  fSelect: { borderWidth: 1, borderColor: '#ddd', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 7, backgroundColor: '#fff', marginRight: 8 },
  fSelectActive: { backgroundColor: '#000', borderColor: '#000' },
  fSelectText: { fontSize: 13, color: '#333' },
  fChip: { borderWidth: 1, borderColor: '#ddd', borderRadius: 16, paddingHorizontal: 12, paddingVertical: 7, backgroundColor: '#fff', marginRight: 8 },
