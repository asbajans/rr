...
const styles = StyleSheet.create({
  ...
  bulkRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, backgroundColor: '#000', borderRadius: 10, marginHorizontal: 16, marginBottom: 8 },
  bulkCount: { fontSize: 13, fontWeight: '600', color: '#fff' },
