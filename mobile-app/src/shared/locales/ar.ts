export const ar: Record<string, string> = {
  ...
  continueToForm: 'المتابعة للنموذج',
  ...
  codePlaceholder: 'تلقائي (من الرابط)',
  titlePlaceholder: 'اقتراح الذكاء الاصطناعي',
  descPlaceholder: 'اقتراح الذكاء الاصطناعي',
  backToAnalyze: 'العودة للتحليل',
  aiCreditsRemaining: 'رصيد الذكاء الاصطناعي المتبقي: {count}',
  noAiCredits: 'لا يوجد رصيد ذكاء اصطناعي. اشترِ باقة.',
