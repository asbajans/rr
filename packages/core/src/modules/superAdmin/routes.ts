...
router.post('/plans', superAdminOnly, [
  ...
  body('productLimit').optional().isInt({ min: 0 }),
  body('product_limit').optional().isInt({ min: 0 }),
...
router.put('/plans/:id', superAdminOnly, [
  ...
  body('productLimit').optional({ values: 'falsy' }).isInt({ min: 0 }),
  body('product_limit').optional({ values: 'falsy' }).isInt({ min: 0 }),
  body('storeLimit').optional({ values: 'falsy' }).isInt({ min: 1 }),
  body('store_limit').optional({ values: 'falsy' }).isInt({ min: 1 }),
  body('aiCredits').optional({ values: 'falsy' }).isInt({ min: 0 }),
  body('ai_credits').optional({ values: 'falsy' }).isInt({ min: 0 }),
