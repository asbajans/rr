...
import { Store, Users, CreditCard, LogOut, FolderTree, Sparkles, Settings, Shield, ChevronLeft, ChevronRight, Truck, Star, Coins, Globe, LifeBuoy, BarChart3, Megaphone, Ticket, Newspaper } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/saas-coupons', labelKey: 'superCoupons', icon: Ticket },
  { href: '/blogs', labelKey: 'superBlogs', icon: Newspaper },
  ...
  { href: '/marketplace-catalog', labelKey: 'superMarketplaceCatalog', icon: Globe },
  { href: '/super/support', labelKey: 'superSupport', icon: LifeBuoy },
  { href: '/super/analytics', labelKey: 'superAnalytics', icon: BarChart3 },
  { href: '/super/marketing', labelKey: 'superMarketing', icon: Megaphone },
