...
import { Users, Search, Eye, ShoppingCart, DollarSign } from 'lucide-react'
    ...
    <div className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="relative">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)}
            ...
            className="w-72 rounded-lg border border-zinc-700 bg-zinc-900 pl-9 pr-3 py-2 text-sm text-white placeholder-zinc-500" />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="mt-12 text-center text-zinc-500">
          ...
          <p className="mt-3 text-sm">{search ? 'Arama sonucu bulunamadı' : 'Henüz müşteri yok'}</p>
        </div>
      ) : (
        <>
