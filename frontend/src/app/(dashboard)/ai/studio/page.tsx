                ...
                <div className="mt-4 space-y-3">
                  ...
                  <div className="border-t border-zinc-700 pt-3">
                    ...
                    <div className="mt-3 rounded-lg border border-zinc-700 bg-zinc-800/60 p-3">
                      ...
                      {draftImages.length > 0 ? (
                        <p className="mt-1 text-[10px] text-zinc-500">Mevcut son görsel referans alınarak üretilecek — sıfırdan isterseniz mevcut görselleri silin.</p>
                      ) : (
                        <p className="mt-1 text-[10px] text-zinc-500">Sıfırdan üretilecek — referans görsel yok.</p>
                      )}
