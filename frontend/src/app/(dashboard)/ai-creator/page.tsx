...
import { Sparkles, Camera, X, CheckCircle, Loader2, ImageUp, ArrowUpRight, Coins } from 'lucide-react'
      ...
      <div className="max-w-xl mx-auto p-8 text-center">
        <div className="inline-flex items-center justify-center gap-3 rounded-xl bg-zinc-100 p-6">
          ...
          <div className="text-left">
            <h1 className="text-lg font-semibold text-zinc-900">AI Ürün Oluşturucu</h1>
