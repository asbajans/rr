      ...
      {step === 'upload' && (
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-4 bg-zinc-50 rounded-xl border border-zinc-200">
            ...
            <div>
              <h3 className="font-semibold text-zinc-900">AI ile Ürün Oluştur</h3>
              <p className="text-sm text-zinc-500">Ürün fotoğrafını yükleyin, AI analiz edip başlık, açıklama, kategori oluşturacak</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex flex-col items-center justify-center gap-2 p-6 border-2 border-dashed border-zinc-300 rounded-xl hover:border-emerald-400 hover:bg-emerald-50 transition-colors"
            >
      ...
      {step === 'form' && analysis && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold">Ürün Bilgilerini Düzenle</h3>
            <button onClick={() => setStep('analyze')} className="text-sm text-indigo-600 hover:underline">← Geri</button>
          </div>
